...
import calculator.operators.ExponentOperator;
...
public class PowerOperatorTest {
    ...
    public void simplePowerTest(){
        ...
        ExponentOperator powerOperator =  new ExponentOperator();
    ...
    public void powerPriorityTest(){
        Assertions.assertEquals(new ExponentOperator().priority(), 3);
    }
}
